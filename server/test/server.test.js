...
describe("DELETE /todos/:id", () => {
    ...
    it('should not remove a todo than not exist', (done) => {
...
describe('PATCH /todos/:id', () => {
    ...
    it('should not update todo eith other user', (done) => {
        var hexId = todos[0]._id.toHexString();
        var text = 'this should be the new text';
    ...
    it('should clear completedAt when todo is not completed', (done) => {
        var hexId = todos[1]._id.toHexString();
        var text = 'this should be other text';
...
describe('POST /user/login', () => {
    it('should login and return auth token', (done) => {
     ...
     it('should reject invalid login', (done) => {
        request(app)
            .post('/users/login')
            .send({email: 'rom@rom.com', password: '123'})
            .expect(400)
            .expect((res) => {
